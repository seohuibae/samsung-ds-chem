...
parser.add_argument('--model', default='GIN', type=str, choices=['simple','transformer', 'GCN', 'GAT', 'GIN'])
...
def main(args):
    ...
    for test_idx in range(4):
        ...
        model_dict = {
            'GIN': GIN(num_input_features=9, num_layers=args.num_layers, hidden_dim=args.hidden_dim, out_dim=args.hidden_dim, dropout=args.dropout),
        }
